...
import FinalNoteAnimation from '@/components/FinalNoteAnimation';
...
const V6 = () => {
  return (
    <div className="min-h-screen bg-white text-white relative overflow-hidden">
      ...
      {/* WHO WE ARE Section */}
      <div className="min-h-screen bg-[#26282D] text-white relative flex items-center justify-center p-8 overflow-hidden">
        <WhoWeAreAnimation />
        <div className="max-w-4xl mx-auto space-y-8 relative z-10">
          <h2 className="text-4xl md:text-5xl font-light tracking-wider text-[#E95F32] text-center mb-12 animate-fade-in">
            WHO WE ARE
          </h2>
          <h3 className="text-2xl md:text-3xl font-light tracking-wide text-center mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="space-y-6 text-lg leading-relaxed">
            ...
            <p className="animate-fade-in" style={{ animationDelay: '1.0s' }}>
      ...
      {/* WHAT WE DO Section */}
      <div className="min-h-screen bg-white text-[#26282D] relative flex items-center justify-center p-8 overflow-hidden">
        <WhatWeDoAnimation />
        <div className="max-w-4xl mx-auto space-y-12 relative z-10">
          <h2 className="text-4xl md:text-5xl font-light tracking-wider text-[#E95F32] text-center mb-12 animate-fade-in">
            WHAT WE DO
          </h2>
          <h3 className="text-2xl md:text-3xl font-light tracking-wide text-center mb-12 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4 animate-fade-in" style={{ animationDelay: '1.0s' }}>
      ...
      <div className="min-h-screen bg-white text-[#26282D] relative flex items-center justify-center p-8 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          <h2 className="text-4xl md:text-6xl font-light tracking-wider text-[#E95F32] animate-scale-in">
            Built to Inspire. Designed to Perform.
          </h2>
          <p className="text-xl md:text-2xl font-light tracking-wide animate-fade-in" style={{ animationDelay: '0.5s' }}>
